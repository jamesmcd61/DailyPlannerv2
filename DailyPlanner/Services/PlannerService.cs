...
namespace DailyPlanner.Services
{
    ...
    public class PlannerService : IPlannerService
    {
        ...
        public async Task<bool> SaveTodoStickyNoteAsync(TodoStickyNote todoStickyNote)
        {
            ...
            return true;
            //var sqlConnection = new SqlConnection(this.Connection);
            //var registerUser = new SqlCommand("INSERT INTO ToDoMessages ([Message], [Date]) VALUES (@message, @date)", sqlConnection);
            //sqlConnection.Open();
            //registerUser.Parameters.AddWithValue("@message", this.encryptionService.Encryption(todoStickyNote.TodoMessage));
            //registerUser.Parameters.AddWithValue("@date", todoStickyNote.DateTodo);
